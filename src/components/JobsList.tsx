  ...
  return (
    ...
    <li key={id}>
     ...
     <div className='w-[79%] ml-5 mg:w-[95%] lg:w-[95%] lg:ml-7 mg:ml-7'>
      ...
      <p className='max-h-12.5 overflow-hidden lg:max-h-full font-normal text-headerColor text-lg mg:max-h-full lg:text-xl mg:text-xl mb-1 lg:mb-2 mg:mb-2 lg:font-bold mg:font-bold'>{title}</p>
